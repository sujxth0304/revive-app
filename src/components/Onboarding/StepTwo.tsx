...
const StepTwo = ({ onNext, onBack }: Props) => {
  return (
    <motion.div
      ...
      className="space-y-6"
    >
      <h2 className="text-2xl font-bold">🎯 Define your goal</h2>
      <p className="text-sm text-gray-300">What outcome do you want to work towards?</p>

      <input
        type="text"
        placeholder="e.g. Build a morning routine"
